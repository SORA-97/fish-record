...
(1, 'azisaba.png', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, DEFAULT, 'タグテスト', DEFAULT, DEFAULT, DEFAULT, '#タグテスト', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
